...
from intelora.core import LIFOBuffer, LifoManager
from intelora.core.Models import Brain, Signal, Singleton
from intelora.core.Models.MatchedSynapse import MatchedSynapse
from intelora.core.Models.Settings import Settings
from intelora.core.SynapseLauncher import SynapseLauncher, SynapseNameNotFound
...
class TestSynapseLauncher(unittest.TestCase):
    ...
    def test_run_matching_synapse_from_order(self):
        ...
        Singleton._instances = dict()
        LifoManager.clean_saved_lifo()
        with mock.patch("intelora.core.HookManager.on_order_not_found") as mock_hook:
        ...
        Singleton._instances = dict()
        with mock.patch("intelora.core.Lifo.LIFOBuffer.execute"):
            with mock.patch("intelora.core.HookManager.on_order_found") as mock_hook:
                order_to_match = "this is the second sentence"
